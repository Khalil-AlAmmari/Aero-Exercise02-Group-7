...
---------------------- INPUT FILES ---------------------------------------------
"WindStep_08_EDFile.dat"	EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"unused"      BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"unused"   	  BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"unused"      BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"WindStep_08_InflowFile.dat"	InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"WindStep_08_AeroFile.dat"	AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"WindStep_08_ServoFile.dat"	ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
